...
bids_root = "/storage/store3/derivatives/CHAT/100Hz/"
preproc_bids_root = "/storage/store3/derivatives/CHAT/2channels/"
datatype = "eeg"
...
def preprocess_and_save(bids_path, preproc_bids_path):
    ...
    try:
        ...
        print(f"Subject {bids_path.subject} has no required channels")
