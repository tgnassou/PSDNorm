...
def save_to_bids(
    ...
    for fileref in common:
        ...
        raw.pick_channels(raw.ch_names[:13])
        mapping = {
            "LOC": "eog",
            "ROC": "eog",
            "ECG1": "ecg",
...
bids_root = "/storage/store3/data/cfs-bids/"
raw_path = "/storage/store3/data/cfs/polysomnography/edfs/"
annot_path = (
    "/storage/store3/data/cfs/polysomnography/annotations-events-nsrr/"
)
