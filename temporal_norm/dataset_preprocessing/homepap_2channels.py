...
bids_root = "/storage/store3/derivatives/HOMEPAP/100Hz/"
preproc_bids_root = "/storage/store3/derivatives/HOMEPAP/2channels/"
datatype = "eeg"
...
def preprocess_and_save(bids_path, preproc_bids_path):
    ...
    try:
        ...
        print(f"Subject {bids_path.subject} has no M1/M2 channels")
