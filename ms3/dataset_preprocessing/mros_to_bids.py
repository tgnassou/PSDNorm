...
bids_root = "/storage/store3/data/mros-bids/"
raw_path = "/storage/store3/data/mros/polysomnography/edfs/"
annot_path = (
    "/storage/store3/data/mros/polysomnography/annotations-events-nsrr/"
)
n_jobs = 1
