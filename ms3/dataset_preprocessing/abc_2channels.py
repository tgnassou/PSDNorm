...
bids_root = "/storage/store3/derivatives/ABC/100Hz/"
preproc_bids_root = "/storage/store3/derivatives/ABC/2channels/"
datatype = "eeg"

all_sub = (
    pd.read_csv(bids_root + "participants.tsv", delimiter="\t", engine="python")[
        "participant_id"
    ]
